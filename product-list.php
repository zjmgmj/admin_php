...
<!--<div class="pos-a" style="width:200px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; background-color:#f5f5f5; overflow:auto;">
	...
	<div class="page-container">
		<div class="text-c"> 日期范围：
			...
			<input type="text" name="" id="searchTitle" placeholder=" 产品名称" style="width:250px" class="input-text">
			<button name="" id="search" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜产品</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" id="deleteALL" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" onclick="product_add('添加产品','product-add.php')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span>
...
<script type="text/javascript" src="js/products_list.js"></script>
